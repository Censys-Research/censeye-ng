...
var DefaultPivotableFields = []string{}         // default pivotable fields is empty (all fields are pivotable by default)
var DefaultCacheDuration = (time.Hour * 24) * 7 // 7 days of cache
